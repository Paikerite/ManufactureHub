        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IdTeamLead = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdTeamLead = table.Column<int>(type: "int", nullable: false),
                    WorkstationViewModelId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.WorkstationViewModelId,
                        principalTable: "Workstations",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "ApplicationUserSectionViewModel",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserSectionViewModel", x => new { x.SectionsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserSectionViewModel_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationUserSectionViewModel_Sections_SectionsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserSectionViewModel_UsersId",
                table: "ApplicationUserSectionViewModel",
                column: "UsersId");
